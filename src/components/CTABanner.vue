<template>
    <div class="relative -z-10 mt-32 px-6 lg:px-8">
        ...
        <div class="mx-auto max-w-2xl text-center">
          <h2 class="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Become Fluent Faster, With YouTube.</h2>
          <p class="mx-auto mt-6 max-w-xl text-lg leading-8 text-gray-600">Turn any YouTube video into language learning lessons. Click words for translation, track your vocabulary, get excellent content recommendations.</p>
